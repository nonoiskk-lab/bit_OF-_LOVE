...
export default function FineDineTransition() {
  return (
    <section className="relative bg-white text-lb-charcoal px-5 md:px-8 py-28 md:py-36 overflow-hidden text-center">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(211,52,31,0.10),transparent_60%)]" />
      <motion.div
        ...
        className="relative"
      >
        <p className="font-number text-xs md:text-sm tracking-[0.3em] uppercase text-lb-red mb-4">
          08 — Fine Dine
        </p>
        ...
        <p className="mt-6 max-w-lg mx-auto text-lb-neutral">
